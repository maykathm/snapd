...
func (plug *ConnectedPlug) StaticAttr(key string, val any) error {
	return getAttribute(plug.Snap().InstanceName().TODOInstanceName(), plug.Interface(), plug.staticAttrs, nil, key, val)
}
...
func (plug *ConnectedPlug) Attr(key string, val any) error {
	return getAttribute(plug.Snap().InstanceName().TODOInstanceName(), plug.Interface(), plug.staticAttrs, plug.dynamicAttrs, key, val)
}
...
func (slot *ConnectedSlot) StaticAttr(key string, val any) error {
	return getAttribute(slot.Snap().InstanceName().TODOInstanceName(), slot.Interface(), slot.staticAttrs, nil, key, val)
}
...
func (slot *ConnectedSlot) Attr(key string, val any) error {
	return getAttribute(slot.Snap().InstanceName().TODOInstanceName(), slot.Interface(), slot.staticAttrs, slot.dynamicAttrs, key, val)
}
