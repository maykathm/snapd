...
app.layout = html.Div([
    ...
    html.H4("1. First input path for either a mongo credential file or a folder containing the data."),
    dcc.Input(id="input-path", type="text", placeholder="full path to mongo cred file or to folder with data."),
    ...
    html.Div(children="", style={'fontSize': '24px', 'marginBottom': '20px'}),
    dbc.Button("Systems coverage vs. all features", id={'type': "toggle-button", 'index': 1}, n_clicks=0, className="mb-3", disabled=True),
    dbc.Collapse(
        html.Div([
    ...
    html.Div(children="", style={'fontSize': '24px', 'marginBottom': '20px'}),
    dbc.Button("Compare feature coverage between systems", id={'type': "toggle-button", 'index': 2}, n_clicks=0, className="mb-3", disabled=True),
    dbc.Collapse(
        html.Div([
    ...
    html.Div(children="", style={'fontSize': '24px', 'marginBottom': '20px'}),
    dbc.Button("Feature coverage matrix per system", id={'type': "toggle-button", 'index': 3}, n_clicks=0, className="mb-3", disabled=True),
    dbc.Collapse(
        html.Div([
    ...
    html.Div(children="", style={'fontSize': '24px', 'marginBottom': '20px'}),
    dbc.Button("Duplicate features", id={'type': "toggle-button", 'index': 4}, n_clicks=0, className="mb-3", disabled=True),
    dbc.Collapse(
        html.Div([
            html.Div(children="Timestamp", style={'marginBottom': '20px'}),
            dcc.Dropdown(
    ...
    html.Div(children="", style={'fontSize': '24px', 'marginBottom': '20px'}),
    dbc.Button("Explore by feature", id={'type': "toggle-button", 'index': 5}, n_clicks=0, className="mb-3", disabled=True),
    dbc.Collapse(
        html.Div([
            html.Div(children="Timestamp", style={'marginBottom': '20px'}),
            dcc.Dropdown(
...
def set_retriever(_, path):
    ...
    if os.path.isfile(path):
        retriever = qf.MongoRetriever(path)
